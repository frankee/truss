...
import (
	...
	handler "github.com/frankee/truss/cmd/_integration-tests/transport/transportpermutations-service/handlers"
	svc "github.com/frankee/truss/cmd/_integration-tests/transport/transportpermutations-service/svc"
)
